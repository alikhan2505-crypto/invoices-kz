...
export const miscDict: Record<'ru' | 'kk' | 'en', MiscContent> = {
  ru: {
    ...
    proPlanName: 'Про',
    maxBadge: 'Максимум',
    proFeatures: ['Безлимитные счета', 'КП, АВР и накладные', 'Kaspi Bot — весь кабинет магазина', 'AI-агент для клиентов', 'WB Bot (скоро)', 'ЭЦП и договоры', 'Приоритетная поддержка'],
    activeLabel: '✓ Активен',
  ...
  kk: {
    ...
    proPlanName: 'Про',
    maxBadge: 'Максимум',
    proFeatures: ['Шексіз шоттар', 'КҰ, ОҚА және жүкқұжаттар', 'Kaspi Bot — дүкен кабинетінің барлығы', 'Клиенттерге арналған AI-агент', 'WB Bot (жақында)', 'ЭЦҚ және шарттар', 'Басым қолдау'],
  ...
  en: {
    ...
    proPlanName: 'Pro',
    maxBadge: 'Maximum',
    proFeatures: ['Unlimited invoices', 'Quotes, acts & delivery notes', 'Kaspi Bot — full shop dashboard', 'AI agent for customers', 'WB Bot (coming soon)', 'e-signature & contracts', 'Priority support'],
    activeLabel: '✓ Active',
