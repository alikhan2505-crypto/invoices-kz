...
export const profileCoreDict: Record<'ru' | 'kk' | 'en', ProfileCoreContent> = {
  ru: {
    ...
    signatureMenuLabel: 'Подпись и печать',
  ...
  kk: {
    ...
    signatureMenuLabel: 'Қолтаңба мен мөр',
    ...
    kpNumberingSectionLabel: 'КП нөмірлеу',
    avrNumberingSectionLabel: 'АВР нөмірлеу',
  ...
  en: {
    ...
    signatureMenuLabel: 'Signature and stamp',
