...
export const profileContentDict: Record<'ru' | 'kk' | 'en', ProfileMiscContent> = {
  ...
  kk: {
    ...
    faqItems: [
      ...
      { q: 'Сынақ мерзіміне не кіреді?', a: 'Pro тарифінің барлық мүмкіндіктеріне шектеусіз 7 күн тегін қолжетімділік.' },
  ...
  en: {
    ...
    faqItems: [
      ...
      { q: 'What does the trial period include?', a: '7 days of free access to all Pro plan features, with no restrictions.' },
