  ...
  const html = `
    ...
    <body>
      ...
      <div style="margin-top:16px; min-height:130px; position:relative;">
        <div style="display:flex; align-items:flex-end; gap:4px; width:90%;">
          ...
          <div style="position:relative; flex:1; min-width:120px;">
            ...
            <img src="${signatureBase64}"
              style="position:absolute; bottom:-10px; left:50px; max-height:50px; max-width:180px; object-fit:contain; object-position:left bottom;" />
            ` : ''}
        ...
        ${stampBase64 ? `
        <img src="${stampBase64}"
          style="position:absolute; left:35%; bottom:15px;
