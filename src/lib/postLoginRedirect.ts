...
export const ALLOWED_POST_LOGIN_REDIRECTS = ['/kaspi-api/docs', '/kaspi-api', '/upgrade', '/kaspi-shop', '/kaspi-shop/overview', '/ai-agent', '/ai-agent/overview', '/admin/site-generator'] as const
