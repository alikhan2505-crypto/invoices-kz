...
7. Приёмы из премиальных референсов (Awwwards-уровня агентские/продуктовые сайты) -- используй те, на которые указывает выбранный паттерн, не все сразу и не там, где паттерн их не просит:
   - Призрачная фоновая типографика: гигантская полупрозрачная буква/слово за заголовком героя. position:absolute; font-size:40vw; opacity:.05-.08; z-index:-1; line-height:1; pointer-events:none -- даёт масштаб и глубину без единой картинки.
