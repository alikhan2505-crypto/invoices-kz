  ...
  return (
    <>
      ...
      {/* top-0 (not top-3): SiteNav renders as this card's first child, and the card's
          ...
          pages at once. Flush top = one bar origin everywhere; bottom corners keep
          the floating-card rounding. */}
      <div className="desktop-shell-glass desktop-shell-scroll lg:fixed lg:top-0 lg:right-3 lg:bottom-3 lg:left-3 lg:rounded-b-[28px] lg:overflow-y-auto lg:shadow-2xl lg:ring-1 lg:ring-black/5">
        {children}
      </div>
    </>
  )
