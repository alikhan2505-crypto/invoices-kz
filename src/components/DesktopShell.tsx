export default function DesktopShell({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <div className="desktop-shell-scroll lg:fixed lg:top-3 lg:right-3 lg:bottom-3 lg:left-3 lg:rounded-[28px] lg:overflow-y-auto lg:shadow-2xl lg:ring-1 lg:ring-black/5 lg:bg-white">
        {children}
      </div>
    </>
  )
