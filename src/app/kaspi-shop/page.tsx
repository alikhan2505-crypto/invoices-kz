          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: EASE }}
            ...
            {!otpToken ? (
              <div className="flex flex-col gap-2 max-w-sm">
                <input className="w-full bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-sm text-white! [color:#fff_!important] [-webkit-text-fill-color:#fff_!important] placeholder:text-white/30 outline-none focus:border-white/30"
              ...
              <div className="flex flex-col gap-2 max-w-sm">
                ...
                <input className="w-full bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-sm text-white! [color:#fff_!important] [-webkit-text-fill-color:#fff_!important] placeholder:text-white/30 outline-none focus:border-white/30 font-mono tracking-widest"
