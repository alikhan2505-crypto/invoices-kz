  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3} placeholder="Оплата в течение 3 рабочих дней..."
        ...
        {/* Нумерация КП */}
        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-4">
          <div className="text-xs text-gray-400 uppercase tracking-wide">Нумерация КП</div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">Префикс</label>
              <input className="w-full border-b border-gray-200 py-2 text-sm outline-none focus:border-[#1C2056]"
        ...
        {/* Нумерация АВР */}
        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-4">
          <div className="text-xs text-gray-400 uppercase tracking-wide">Нумерация АВР</div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">Префикс</label>
              <input className="w-full border-b border-gray-200 py-2 text-sm outline-none focus:border-[#1C2056]"
        ...
        {/* Нумерация Накладной */}
        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-4">
          <div className="text-xs text-gray-400 uppercase tracking-wide">Нумерация Накладных</div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-gray-500 mb-1 block">Префикс</label>
              <input className="w-full border-b border-gray-200 py-2 text-sm outline-none focus:border-[#1C2056]"
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4">
          ...
          {settings.vat_type === 'vat_16' && (
            <div className="mt-3 bg-blue-50 rounded-xl p-3 text-xs text-blue-700">
              💡 В счетах будет автоматически рассчитываться НДС 16%
            </div>
          )}
          ...
          {settings.vat_type === 'no_vat' && (
            <div className="mt-3 bg-gray-50 rounded-xl p-3 text-xs text-gray-500">
              💡 В счетах будет написано "Без НДС"
            </div>
          )}
        </div>
