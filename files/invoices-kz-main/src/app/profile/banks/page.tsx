                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!acc.is_main && (
                      <button onClick={() => setMain(acc.id)}
                        className="text-gray-300 hover:text-yellow-400 text-xl" title="Сделать основным">
                        ☆
                      </button>
                    )}
                    {acc.is_main && (
                    ...
                    <button onClick={() => startEdit(acc)}
                      className="text-gray-300 hover:text-[#1C2056] text-lg" title="Редактировать">
                      ✏️
                    </button>
                    {/* Крестик — удалить */}
                    <button onClick={() => deleteAccount(acc.id)}
                      className="text-gray-300 hover:text-red-400 text-lg" title="Удалить">
                      ✕
                    </button>
                  </div>
                </div>
